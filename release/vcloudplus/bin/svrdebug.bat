...
"%EXECUTABLE%" //US//%SERVICE_NAME% ++JvmOptions "-Xdebug;-Xrunjdwp:transport=dt_socket,address=localhost:9528,server=y,suspend=n;-Dcom.sun.management.jmxremote;-Dcom.sun.management.jmxremote.port=9527;-Dcom.sun.management.jmxremote.ssl=false;-Dcom.sun.management.jmxremote.authenticate=false;-Djava.rmi.server.hostname=localhost;-XX:HeapDumpPath=%VCLOUDPLUS_BASE%/dump/java_pid<pid>.hprof;-XX:ErrorFile=%VCLOUDPLUS_BASE%/log/hs_err_pid<pid>.log;-Dvcplog.home=%VCLOUDPLUS_BASE%\log;-Dlog4j.configuration=file:%VCLOUDPLUS_BASE%/config/log4j.properties;-Dvcloudplus.properties=%VCLOUDPLUS_BASE%/config/vcloudplus.properties;-Dorg.quartz.properties=%VCLOUDPLUS_BASE%/config/quartz_node.properties" --JvmMs 32 --JvmMx 128
